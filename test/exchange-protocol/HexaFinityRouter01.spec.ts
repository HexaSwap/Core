...
enum RouterVersion {
  HexaFinityRouter01 = 'HexaFinityRouter01',
  HexaFinityRouter02 = 'HexaFinityRouter02',
}

describe('HexaFinityRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async () => {
      ...
      router = {
        [RouterVersion.HexaFinityRouter01]: fixture.router01,
        [RouterVersion.HexaFinityRouter02]: fixture.router02,
    ...
    describe('Remove liquidity', () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.HexaFinityRouter01]: 102193,
              [RouterVersion.HexaFinityRouter02]: 103177,
            }[routerVersion as RouterVersion],
          );
        }).retries(3);
      });
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.HexaFinityRouter01]: 138979,
              [RouterVersion.HexaFinityRouter02]: 139932,
            }[routerVersion as RouterVersion],
          );
        }).retries(3);
      });
